...
**Tool:** All screenshots use `agent-browser screenshot` (Agent Browser). Browser MUST be started with `agent-browser open --headless <url>`. Each subagent uses its own independent browser session.
