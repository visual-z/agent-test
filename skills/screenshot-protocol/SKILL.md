...
**Tool:** All screenshots use `agent-browser screenshot` (Agent Browser). Browser MUST be launched with `agent-browser launch --headless`. Each subagent uses its own independent browser session.
